...
var testModulePath = path.join(process.cwd(), "./lib/db/handlers/replicate-to.js");
var mockMessages = path.join(process.cwd(), "tests", "mock-messages", "./lib/db/handlers/replicate-to.js");
...
describe("#replicate-to", async function(){
  var cleanUpPids = [];
