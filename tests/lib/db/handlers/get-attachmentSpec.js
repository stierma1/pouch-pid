...
var testModulePath = path.join(process.cwd(), "./lib/db/handlers/get-attachment.js");
var mockMessages = path.join(process.cwd(), "tests", "mock-messages", "./lib/db/handlers/get-attachment.js");
...
describe("#get-attachment", async function(){
  var cleanUpPids = [];
