...
var testModulePath = path.join(process.cwd(), "./lib/db/handlers/remove-attachment.js");
var mockMessages = path.join(process.cwd(), "tests", "mock-messages", "./lib/db/handlers/remove-attachment.js");
...
describe("#remove-attachment", async function(){
  var cleanUpPids = [];
