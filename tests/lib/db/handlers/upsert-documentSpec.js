...
var testModulePath = path.join(process.cwd(), "./lib/db/handlers/upsert-document.js");
var mockMessages = path.join(process.cwd(), "tests", "mock-messages", "./lib/db/handlers/upsert-document.js");
...
describe("#upsert-document", async function(){
  var cleanUpPids = [];
