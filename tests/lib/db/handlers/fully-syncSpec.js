...
var testModulePath = path.join(process.cwd(), "./lib/db/handlers/fully-sync.js");
var mockMessages = path.join(process.cwd(), "tests", "mock-messages", "./lib/db/handlers/fully-sync.js");
...
describe("#fully-sync", async function(){
  var cleanUpPids = [];
