...
var testModulePath = path.join(process.cwd(), "./lib/db/handlers/all-docs.js");
var mockMessages = path.join(process.cwd(), "tests", "mock-messages", "./lib/db/handlers/all-docs.js");
...
describe("#all-docs", async function(){
  var cleanUpPids = [];
