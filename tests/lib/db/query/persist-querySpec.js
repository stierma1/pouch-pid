...
var testModulePath = path.join(process.cwd(), "./lib/db/query/persist-query.js");
var mockMessages = path.join(process.cwd(), "tests", "mock-messages", "./lib/db/query/persist-query.js");
...
describe("#persist-query", async function(){
  var cleanUpPids = [];
