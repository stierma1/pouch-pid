...
var testModulePath = path.join(process.cwd(), "./lib/db/erase.js");
var mockMessages = path.join(process.cwd(), "tests", "mock-messages", "./lib/db/erase.js");
