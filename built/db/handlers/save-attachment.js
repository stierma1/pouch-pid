...
module.exports.main = function () {
  var _ref = _asyncToGenerator(regeneratorRuntime.mark(function _callee() {
    var _ref2, _ref3, db, docId, attachmentName, dataB64, mimeType, returnPid, error, result;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 2:
            ...
            error = null;
            _context.next = 13;
            return db.putAttachment(docId, attachmentName, dataB64, mimeType).catch(function (err) {
              error = err;
            });
